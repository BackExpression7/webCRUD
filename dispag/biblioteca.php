               ...
               <td>Titilo <?php echo  "<span id='tit'>{$document['manga_title']}</span>";?><br/>
                ...
                <td><div id="modal2" class="modal2">
                    ...
                    <div class="modal-body2" align="center">
                        <a href="#" onclick="modalbiblioteca()" class="opis" style="background-color: #54DCC1;">agregar</a><br/><br/>
                    </div>
                    </div>
                </div></td>
           </tr>
            ...
            <div class="flex" id="flex">
                <div class="contenido-modal">
                    <div class="modal-header">
                        <h2 align="center">acabe de agregar su libro seleccionado</h2>
                    </div>
                    <div class="modal-body" align="center">
                    <form action="send.php?var=<?php echo $usuario?>&var1=<?php echo $titul?>&var2=1" method="post">
